...
class UpdateChecker implements Runnable {
    ...
    public void run() {
        ...
        try {
            URL url = new URL("https://github.com/nrubin29/circlesorter/tree/gh-pages/version.html?raw=true");
        ...
        if (!remoteVersion.equals(VERSION)) {
            try {
                URL url = new URL("https://github.com/nrubin29/circlesorter/tree/gh-pages/circlesorter.jar?raw=true");
